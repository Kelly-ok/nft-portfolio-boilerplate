...
export async function POST(request: NextRequest) {
  try {
    ...
    // Construct the NFTGo API URL for listings
    const nftgoUrl = `${API_BASE_URL}/trade/v1/nft/listings`;

    console.log('Proxying listings request to NFTGo API:', nftgoUrl);
    ...
    console.error('Error in NFTGo listings proxy API route:', error);
    return NextResponse.json(
